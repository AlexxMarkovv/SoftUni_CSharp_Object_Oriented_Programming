...
namespace Skeleton
{
    ...
    public class AxeTests
    {
        ...
        [Test]
        public void Test_AxeAttackMethodShouldDecreaseDurabilityPoints()
        {
            for (int i = 0; i < 5; i++)
            {
                axe.Attack(dummy);
        ...
        [Test]
        public void Test_AxeAttack_ShouldThrowExceptionWhenDurabilityIs0()
        {
            axe = new Axe(10, 0);
        ...
        [Test]
        public void Test_AxeAttack_ShouldThrowExceptionWhenDurabilityIsNegative()
        {
            axe = new Axe(10, -5);
